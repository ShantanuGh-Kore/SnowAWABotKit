...
module.exports = {
    ...
    getMessages: function(requestData, callback) {
        ...
        var channel = requestData.channel.type || requestData.channel.channelInfos.type
        var userId = requestData.userId || requestData.channel.userId || requestData.channel.channelInfos.userId;
        var url = `${requestData.baseUrl}/getMessages?skip=${offset}&limit=${limit}&userId=${userId}&channelType=${channel}`;
        console.log("Chat history call URL = " + url);
