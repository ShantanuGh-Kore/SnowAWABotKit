...
function OnclientEventPayload(requestId, botId, componentId, opts) {
    BasePayload.call(this, requestId, botId, componentId);
    this.payloadClassName   = 'OnclientEventPayload';
    ...
    this.toJSON             = function () {
        return {
            __payloadClass      : 'OnclientEventPayload',
            requestId           : requestId,
            botId               : botId,
...
util.inherits(OnclientEventPayload, BasePayload);

module.exports = OnclientEventPayload;
